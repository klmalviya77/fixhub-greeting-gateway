      ...
      <Container>
        <div className="text-center mb-8">
          ...
          <p className="text-fixhub-dark-gray">
            Welcome back! Log in to manage your bookings and appointments
          </p>
        </div>
            ...
            <form onSubmit={handleLogin}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/user/forgot-password" className="text-sm text-fixhub-blue hover:underline">
                      Forgot password?
                    </Link>
                  </div>
                  <Input 
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <p className="text-sm text-center">
                  ...
                  <Link to="/user/signup" className="text-fixhub-blue hover:underline">
                    Sign Up
                  </Link>
                </p>
              </CardFooter>
